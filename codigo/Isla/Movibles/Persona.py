        ...
        if self.trabajando:
            ...
            if self.tiempoTrabajando == 0:
                ...
                if not objetoTrabajado is None:
                    if objetoTrabajado.getValor() is None:
