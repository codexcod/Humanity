...
class CargarPartidaControlador:
    ...
    def crearObjetos(self):
        ...
        for partida in self.partidas:
            ...
            self.botonesIniciar.append(Partida((self.ancho-150,(i*155)),20,"  Elegir Isla  ",self.screen,"white","black","brown",partida))
            self.botonesBorrar.append(Partida((self.ancho-10,(i*155)),20,"  Borrar Isla  ",self.screen,"white","black","brown",partida))
        
        #Por cada slot de partida vacio crear un boton "Nueva Partida"
        for i in range(3 - self.nuevasPartidas + 1, 3 + 1):
            self.botonesNew.append(Button((self.ancho-10,(i*155)),20,"Nueva Partida",self.screen,"white","black","brown"))
        ...
        self.botonAceptar = Button((self.ancho / 2 , self.alto / 2 + 45), 24, "   Si   ", self.screen, "black", "black", "grey")
        self.botonRechazar = Button((self.ancho / 2 + 85 , self.alto / 2 + 45), 24, "   No   ", self.screen, "black", "black", "grey")
